...
long LeeTag(){
  ...
  if (receivedTag){
    tagString=tagNumber;
    //tagNumber = 590040155458 -> quitar 5900 (inicio) y 58 (final) -> 401554 (hexadecimal) -> 4199764 (decimal, número llavero RFID)
    tagString = tagString.substring(5,11);

    // HEX to DEC 
    String hexstring = "#" + tagString;
